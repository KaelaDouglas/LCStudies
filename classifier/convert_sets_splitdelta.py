...
def convertFile_closestonly(filename, deltamask, outname, partID1, partID2):
    ...
    truID, trueta, truphi, trupt, trum, clus_e, clus_eta, clus_phi, clus_pt, clus_mass, full_indices, mindist_inds = gu.find_closest(truthID_sel, trutheta_sel, truthphi_sel, truthpt_sel, truthmass_sel, clusE_sel, clusEta_sel, clusPhi_sel, clusPt_sel, clusmass_sel, partID1)
